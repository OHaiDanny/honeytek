...
import CtfProductDetailPageGgl from "@src/components/features/ctf-components/ctf-product-detail-page/ctf-product-detail-page-gql"
...
const ProductSlugPage: NextPage = () => {
  const router = useRouter()
  const slug = (router?.query.slug as string) || ""

  return <CtfProductDetailPageGgl slug={slug} />
}
